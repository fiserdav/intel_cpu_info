...
${OBJECTDIR}/cpuid_c.o: cpuid_c.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cpuid_c.o cpuid_c.cpp

${OBJECTDIR}/cpuid_c.h.gch: cpuid_c.h
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o "$@" cpuid_c.h
...
${OBJECTDIR}/modules/ArchInfo.o: modules/ArchInfo.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/ArchInfo.o modules/ArchInfo.cpp

${OBJECTDIR}/modules/CpuInfo.o: modules/CpuInfo.cpp
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/CpuInfo.o modules/CpuInfo.cpp

${OBJECTDIR}/modules/PDInfo.o: modules/PDInfo.cpp
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/PDInfo.o modules/PDInfo.cpp

${OBJECTDIR}/modules/TsxCheck.o: modules/TsxCheck.cpp
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/TsxCheck.o modules/TsxCheck.cpp
